...
<div class="max-w-3xl mx-auto">
    <a href="{{ route('books.index') }}"
       class="text-sm text-emerald-700 hover:underline mb-4 inline-block">
        ← Retour au catalogue
    </a>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex gap-6">
        ...
        {{-- Couverture --}}
        <div class="w-36 h-48 bg-emerald-50 rounded-lg flex items-center
            ...
            <div class="bg-gray-50 rounded-lg p-4 mb-4">
                ...
                <div class="flex gap-1 mb-2">
                    @for($i = 0; $i < $book->total_copies; $i++)
                        <div class="w-8 h-8 rounded-md flex items-center
